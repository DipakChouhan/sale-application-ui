...
export class UserService {
    ...
    registerUser(signUpModel: any) {
      return this.httpClient.post("https://18.188.123.203:8082/security/userDetails/register", signUpModel, {headers: this.httpRequestHeaders});
    }
    ...
    getUserDetails(userEmail: any) {
      return this.httpClient.post("https://18.188.123.203:8082/security/userDetails/getUserDetails", userEmail);
